...
public class Verification extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		userEmailId=bundle.getString("emailid");
  		Toast.makeText(getApplicationContext(), "Emailid"+userEmailId, Toast.LENGTH_SHORT).show();
	...
	public void submitVerificaitonId(View v){
		...
		try {
        	...
        	System.out.println("ResponseTExt"+responseText);
          	...
          	String abc=jsonObject.getString("Result").toString();
          	int registration=Integer.parseInt(jsonObject.getString("Result").toString());
          	String asd =jsonObject.getString("query").toString();
          	System.out.println("abcString Value******"+abc);
